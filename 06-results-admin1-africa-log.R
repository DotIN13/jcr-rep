  ...
  for (j in viol) {
    ...
    for (k in fw) {
      ...
      for (l in 1:length(col1)) {
        ...
        data.temp <- eval(readRDS(paste0("rds/predictions/log/", paste(paste(tolower(col2[l]), "adm1_afr", i, j, tolower(col1[l]), k, sep = "_"), "rds", sep = "."))))
      ...
      for (l in 1:length(col4)) {
        ...
        model.temp <- eval(readRDS(paste0("rds/ml_models/log/", paste(paste("rf_adm1_afr", i, j, tolower(col4[l]), k, sep = "_"), "rds", sep = "."))))
        ...
        if (col4[l] == "Gtw") {
          ...
          pdf(paste0("figures/pdp_plots/log/adm1_afr/", paste("pdp.adm1.afr", i, j, ifelse(str_detect(col4[l], "_"), tolower(str_replace_all(col4[l], "_", ".")), tolower(col4[l])), k, "pdf", sep = ".")), width = 10, height = 6)
        ...
        ggsave(
          filename = paste0("figures/tuning_plots/log/adm1_afr/", paste("tuning.adm1.afr", i, j, ifelse(str_detect(col4[l], "_"), tolower(str_replace_all(col4[l], "_", ".")), tolower(col4[l])), k, "pdf", sep = ".")),
          plot = toplot,
          width = 12,
          height = 6,
          dpi = 300
        ...
        ggsave(
          filename = paste0("figures/varimp_plots/log/adm1_afr/", paste("varimp.adm1.afr", i, j, ifelse(str_detect(col4[l], "_"), tolower(str_replace_all(col4[l], "_", ".")), tolower(col4[l])), k, "pdf", sep = ".")),
          plot = toplot,
          width = 12,
          height = 6,
          dpi = 300
        ...
        print(xtable::xtable(vimp %>%
              ...
              file = paste0("tables/log/adm1_afr/", paste("varimp.adm1.afr", i, j, ifelse(str_detect(col4[l], "_"), tolower(str_replace_all(col4[l], "_", ".")), tolower(col4[l])), k, "tex", sep = "."))
        )
      ...
      for (l in 1:length(col4)) {
        ...
        data.temp <- eval(readRDS(paste0("rds/predictions/log/", paste(print(paste("test_adm1_afr", i, j, tolower(col4[l]), k, sep = "_")), "rds", sep = ".")))) %>%
      ...
      ggsave(
        filename = paste0("figures/maps/log/adm1_afr/", paste("map.adm1.afr", i, j, k, "pdf", sep = ".")),
        plot = toplot,
        width = 12,
        height = 6,
        dpi = 300
      ...
      print(xtable::xtable(metrics.temp.reg,
            ...
            hline.after = c(0, 0, 2, 4, 6, 8, 10, 12, 14),
            # floating.environment = "sidewaystable",
            file = paste0("tables/log/adm1_afr/", paste("metrics.adm1.afr", i, j, k, "tex", sep = ".")))
      
      ## this is to replace [ht] with [!htbp] to make four tables fit on one page in the appendix
      input_dir <- "tables/log/adm1_afr/"
      ...
      ggsave(
        filename = paste0("figures/metrics_plots/log/adm1_afr/", paste("mp.adm1.afr", i, j, k, "pdf", sep = ".")),
        metricsplot.reg.red, 
        width = 12,
        height = 6,
        dpi = 120
...
for (j in viol) {
  ...
  for (k in fw) {
    ...
    ggsave(
      filename = paste0("figures/metrics_plots/log/adm1_afr/", paste("mp.adm1.afr", j, k, "pdf", sep = ".")),
      metricsplot, 
      width = 12,
      height = 6,
      dpi = 120
