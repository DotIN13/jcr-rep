...
data_adm0_afr_2023_sri_bm_fw3 <- readRDS("rds/data/data_adm0_afr_sri_bm.rds") %>%
  group_by(gwno) %>%
...
data_adm0_afr_2023_sri_gtw_fw3 <- readRDS("rds/data/data_adm0_afr_sri_gtw.rds") %>%
  group_by(gwno) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
  arrange(timeindex, gwno)
...
data_adm0_afr_2023_sri_cov_fw3 <- readRDS("rds/data/data_adm0_afr_sri_cov.rds") %>%
  group_by(gwno) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
  arrange(timeindex, gwno)
...
data_adm0_afr_2023_sri_bm_gtw_fw3 <- readRDS("rds/data/data_adm0_afr_sri_bm_gtw.rds") %>%
  group_by(gwno) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
  arrange(timeindex, gwno)
...
data_adm0_afr_2023_sri_cov_gtw_fw3 <- readRDS("rds/data/data_adm0_afr_sri_cov_gtw.rds") %>%
  group_by(gwno) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
  arrange(timeindex, gwno)
...
data_adm0_afr_2023_sri_bm_cov_fw3 <- readRDS("rds/data/data_adm0_afr_sri_bm_cov.rds") %>%
  group_by(gwno) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
  arrange(timeindex, gwno)
...
data_adm0_afr_2023_sri_bm_cov_gtw_fw3 <- readRDS("rds/data/data_adm0_afr_sri_bm_cov_gtw.rds") %>%
  group_by(gwno) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
  arrange(timeindex, gwno)
...
rf_adm0_afr_2023_sri_bm_fw3 <- train(sri_num ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                     ...
                                     verbose = FALSE)
saveRDS(rf_adm0_afr_2023_sri_bm_fw3, "rds/ml_models/rf_adm0_afr_2023_sri_bm_fw3.rds")
...
rf_adm0_afr_2023_sri_cov_fw3 <- train(sri_num ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                      ...
                                      importance = "permutation",
                                      verbose = FALSE)
saveRDS(rf_adm0_afr_2023_sri_cov_fw3, "rds/ml_models/rf_adm0_afr_2023_sri_cov_fw3.rds")
...
rf_adm0_afr_2023_sri_gtw_fw3 <- train(sri_num ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                      ...
                                      importance = "permutation",
                                      verbose = FALSE)
saveRDS(rf_adm0_afr_2023_sri_gtw_fw3, "rds/ml_models/rf_adm0_afr_2023_sri_gtw_fw3.rds")
...
rf_adm0_afr_2023_sri_bm_gtw_fw3 <- train(sri_num ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                         ...
                                         importance = "permutation",
                                         verbose = FALSE)
saveRDS(rf_adm0_afr_2023_sri_bm_gtw_fw3, "rds/ml_models/rf_adm0_afr_2023_sri_bm_gtw_fw3.rds")
...
rf_adm0_afr_2023_sri_cov_gtw_fw3 <- train(sri_num ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                          ...
                                          importance = "permutation",
                                          verbose = FALSE)
saveRDS(rf_adm0_afr_2023_sri_cov_gtw_fw3, "rds/ml_models/rf_adm0_afr_2023_sri_cov_gtw_fw3.rds")
...
rf_adm0_afr_2023_sri_bm_cov_fw3 <- train(sri_num ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                         ...
                                         importance = "permutation",
                                         verbose = FALSE)
saveRDS(rf_adm0_afr_2023_sri_bm_cov_fw3, "rds/ml_models/rf_adm0_afr_2023_sri_bm_cov_fw3.rds")
...
rf_adm0_afr_2023_sri_bm_cov_gtw_fw3 <- train(sri_num ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                             ...
                                             importance = "permutation",
                                             verbose = FALSE)
saveRDS(rf_adm0_afr_2023_sri_bm_cov_gtw_fw3, "rds/ml_models/rf_adm0_afr_2023_sri_bm_cov_gtw_fw3.rds")
...
# rfbm_adm0_afr_2023_sri_cov_fw3 <- readRDS("rds/ml_models/rfbm_adm0_afr_2023_sri_cov_fw3.rds")
# rfbm_adm0_afr_2023_sri_gtw_fw3 <- readRDS("rds/ml_models/rfbm_adm0_afr_2023_sri_gtw_fw3.rds")
# rfcov_adm0_afr_2023_sri_gtw_fw3 <- readRDS("rds/ml_models/rfcov_adm0_afr_2023_sri_gtw_fw3.rds")
# rfbm_cov_adm0_afr_2023_sri_gtw_fw3 <- readRDS("rds/ml_models/rfbm_cov_adm0_afr_2023_sri_gtw_fw3.rds")
...
saveRDS(train_adm0_afr_2023_sri_bm_fw3, "rds/predictions/train_adm0_afr_2023_sri_bm_fw3.rds")
saveRDS(test_adm0_afr_2023_sri_bm_fw3, "rds/predictions/test_adm0_afr_2023_sri_bm_fw3.rds")
...
saveRDS(train_adm0_afr_2023_sri_cov_fw3, "rds/predictions/train_adm0_afr_2023_sri_cov_fw3.rds")
saveRDS(test_adm0_afr_2023_sri_cov_fw3, "rds/predictions/test_adm0_afr_2023_sri_cov_fw3.rds")
...
saveRDS(train_adm0_afr_2023_sri_gtw_fw3, "rds/predictions/train_adm0_afr_2023_sri_gtw_fw3.rds")
saveRDS(test_adm0_afr_2023_sri_gtw_fw3, "rds/predictions/test_adm0_afr_2023_sri_gtw_fw3.rds")
...
saveRDS(train_adm0_afr_2023_sri_bm_cov_fw3, "rds/predictions/train_adm0_afr_2023_sri_bm_cov_fw3.rds")
saveRDS(test_adm0_afr_2023_sri_bm_cov_fw3, "rds/predictions/test_adm0_afr_2023_sri_bm_cov_fw3.rds")
...
saveRDS(train_adm0_afr_2023_sri_bm_gtw_fw3, "rds/predictions/train_adm0_afr_2023_sri_bm_gtw_fw3.rds")
saveRDS(test_adm0_afr_2023_sri_bm_gtw_fw3, "rds/predictions/test_adm0_afr_2023_sri_bm_gtw_fw3.rds")
...
saveRDS(train_adm0_afr_2023_sri_cov_gtw_fw3, "rds/predictions/train_adm0_afr_2023_sri_cov_gtw_fw3.rds")
saveRDS(test_adm0_afr_2023_sri_cov_gtw_fw3, "rds/predictions/test_adm0_afr_2023_sri_cov_gtw_fw3.rds")
...
saveRDS(train_adm0_afr_2023_sri_bm_cov_gtw_fw3, "rds/predictions/train_adm0_afr_2023_sri_bm_cov_gtw_fw3.rds")
saveRDS(test_adm0_afr_2023_sri_bm_cov_gtw_fw3, "rds/predictions/test_adm0_afr_2023_sri_bm_cov_gtw_fw3.rds")
