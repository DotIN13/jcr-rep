...
data_adm1_afr_2022_sri_bm_fw3 <- readRDS("rds/data/log/data_adm1_afr_sri_bm.rds") %>%
  filter(year <= 2022) %>%
...
data_adm1_afr_2022_sri_gtw_fw3 <- readRDS("rds/data/log/data_adm1_afr_sri_gtw.rds") %>%
  filter(year <= 2022) %>%
  group_by(isocode2full) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm1_afr_2022_sri_cov_fw3 <- readRDS("rds/data/log/data_adm1_afr_sri_cov.rds") %>%
  filter(year <= 2022) %>%
  group_by(isocode2full) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm1_afr_2022_sri_bm_gtw_fw3 <- readRDS("rds/data/log/data_adm1_afr_sri_bm_gtw.rds") %>%
  filter(year <= 2022) %>%
  group_by(isocode2full) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm1_afr_2022_sri_cov_gtw_fw3 <- readRDS("rds/data/log/data_adm1_afr_sri_cov_gtw.rds") %>%
  filter(year <= 2022) %>%
  group_by(isocode2full) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm1_afr_2022_sri_bm_cov_fw3 <- readRDS("rds/data/log/data_adm1_afr_sri_bm_cov.rds") %>%
  filter(year <= 2022) %>%
  group_by(isocode2full) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm1_afr_2022_sri_bm_cov_gtw_fw3 <- readRDS("rds/data/log/data_adm1_afr_sri_bm_cov_gtw.rds") %>%
  filter(year <= 2022) %>%
  group_by(isocode2full) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
set.seed(0815)
rf_adm1_afr_2022_sri_bm_fw3 <- train(sri_num_log ~. - gadmname - isocode2full - year - month - timeindex,
                                     ...
                                     verbose = FALSE)
saveRDS(rf_adm1_afr_2022_sri_bm_fw3, "rds/ml_models/log/rf_adm1_afr_2022_sri_bm_fw3.rds")

set.seed(0815)
rf_adm1_afr_2022_sri_cov_fw3 <- train(sri_num_log ~. - gadmname - isocode2full - year - month - timeindex,
                                      ...
                                      importance = "permutation",
                                      verbose = FALSE)
saveRDS(rf_adm1_afr_2022_sri_cov_fw3, "rds/ml_models/log/rf_adm1_afr_2022_sri_cov_fw3.rds")

set.seed(0815)
rf_adm1_afr_2022_sri_gtw_fw3 <- train(sri_num_log ~. - gadmname - isocode2full - year - month - timeindex,
                                      ...
                                      importance = "permutation",
                                      verbose = FALSE)
saveRDS(rf_adm1_afr_2022_sri_gtw_fw3, "rds/ml_models/log/rf_adm1_afr_2022_sri_gtw_fw3.rds")

set.seed(0815)
rf_adm1_afr_2022_sri_bm_gtw_fw3 <- train(sri_num_log ~. - gadmname - isocode2full - year - month - timeindex,
                                         ...
                                         importance = "permutation",
                                         verbose = FALSE)
saveRDS(rf_adm1_afr_2022_sri_bm_gtw_fw3, "rds/ml_models/log/rf_adm1_afr_2022_sri_bm_gtw_fw3.rds")

set.seed(0815)
rf_adm1_afr_2022_sri_cov_gtw_fw3 <- train(sri_num_log ~. - gadmname - isocode2full - year - month - timeindex,
                                          ...
                                          importance = "permutation",
                                          verbose = FALSE)
saveRDS(rf_adm1_afr_2022_sri_cov_gtw_fw3, "rds/ml_models/log/rf_adm1_afr_2022_sri_cov_gtw_fw3.rds")

set.seed(0815)
rf_adm1_afr_2022_sri_bm_cov_fw3 <- train(sri_num_log ~. - gadmname - isocode2full - year - month - timeindex,
                                         ...
                                         importance = "permutation",
                                         verbose = FALSE)
saveRDS(rf_adm1_afr_2022_sri_bm_cov_fw3, "rds/ml_models/log/rf_adm1_afr_2022_sri_bm_cov_fw3.rds")

set.seed(0815)
rf_adm1_afr_2022_sri_bm_cov_gtw_fw3 <- train(sri_num_log ~. - gadmname - isocode2full - year - month - timeindex,
                                             ...
                                             importance = "permutation",
                                             verbose = FALSE)
saveRDS(rf_adm1_afr_2022_sri_bm_cov_gtw_fw3, "rds/ml_models/log/rf_adm1_afr_2022_sri_bm_cov_gtw_fw3.rds")
...
# rfbm_adm1_afr_2022_sri_cov_fw3 <- readRDS("rds/ml_models/log/rfbm_adm1_afr_2022_sri_cov_fw3.rds")
# rfbm_adm1_afr_2022_sri_gtw_fw3 <- readRDS("rds/ml_models/log/rfbm_adm1_afr_2022_sri_gtw_fw3.rds")
# rfcov_adm1_afr_2022_sri_gtw_fw3 <- readRDS("rds/ml_models/log/rfcov_adm1_afr_2022_sri_gtw_fw3.rds")
# rfbm_cov_adm1_afr_2022_sri_gtw_fw3 <- readRDS("rds/ml_models/log/rfbm_cov_adm1_afr_2022_sri_gtw_fw3.rds")
...
saveRDS(train_adm1_afr_2022_sri_bm_fw3, "rds/predictions/log/train_adm1_afr_2022_sri_bm_fw3.rds")
saveRDS(test_adm1_afr_2022_sri_bm_fw3, "rds/predictions/log/test_adm1_afr_2022_sri_bm_fw3.rds")
...
saveRDS(train_adm1_afr_2022_sri_cov_fw3, "rds/predictions/log/train_adm1_afr_2022_sri_cov_fw3.rds")
saveRDS(test_adm1_afr_2022_sri_cov_fw3, "rds/predictions/log/test_adm1_afr_2022_sri_cov_fw3.rds")
...
saveRDS(train_adm1_afr_2022_sri_gtw_fw3, "rds/predictions/log/train_adm1_afr_2022_sri_gtw_fw3.rds")
saveRDS(test_adm1_afr_2022_sri_gtw_fw3, "rds/predictions/log/test_adm1_afr_2022_sri_gtw_fw3.rds")
...
saveRDS(train_adm1_afr_2022_sri_bm_cov_fw3, "rds/predictions/log/train_adm1_afr_2022_sri_bm_cov_fw3.rds")
saveRDS(test_adm1_afr_2022_sri_bm_cov_fw3, "rds/predictions/log/test_adm1_afr_2022_sri_bm_cov_fw3.rds")
...
saveRDS(train_adm1_afr_2022_sri_bm_gtw_fw3, "rds/predictions/log/train_adm1_afr_2022_sri_bm_gtw_fw3.rds")
saveRDS(test_adm1_afr_2022_sri_bm_gtw_fw3, "rds/predictions/log/test_adm1_afr_2022_sri_bm_gtw_fw3.rds")
...
saveRDS(train_adm1_afr_2022_sri_cov_gtw_fw3, "rds/predictions/log/train_adm1_afr_2022_sri_cov_gtw_fw3.rds")
saveRDS(test_adm1_afr_2022_sri_cov_gtw_fw3, "rds/predictions/log/test_adm1_afr_2022_sri_cov_gtw_fw3.rds")
...
saveRDS(train_adm1_afr_2022_sri_bm_cov_gtw_fw3, "rds/predictions/log/train_adm1_afr_2022_sri_bm_cov_gtw_fw3.rds")
saveRDS(test_adm1_afr_2022_sri_bm_cov_gtw_fw3, "rds/predictions/log/test_adm1_afr_2022_sri_bm_cov_gtw_fw3.rds")
