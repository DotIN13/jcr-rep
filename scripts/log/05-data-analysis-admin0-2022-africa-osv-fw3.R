...
data_adm0_afr_2022_osv_bm_fw3 <- readRDS("rds/data/log/data_adm0_afr_osv_bm.rds") %>%
  filter(year <= 2022) %>%
  group_by(gwno) %>%
...
data_adm0_afr_2022_osv_gtw_fw3 <- readRDS("rds/data/log/data_adm0_afr_osv_gtw.rds") %>%
  filter(year <= 2022) %>%
  group_by(gwno) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm0_afr_2022_osv_cov_fw3 <- readRDS("rds/data/log/data_adm0_afr_osv_cov.rds") %>%
  filter(year <= 2022) %>%
  group_by(gwno) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm0_afr_2022_osv_bm_gtw_fw3 <- readRDS("rds/data/log/data_adm0_afr_osv_bm_gtw.rds") %>%
  filter(year <= 2022) %>%
  group_by(gwno) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm0_afr_2022_osv_cov_gtw_fw3 <- readRDS("rds/data/log/data_adm0_afr_osv_cov_gtw.rds") %>%
  filter(year <= 2022) %>%
  group_by(gwno) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm0_afr_2022_osv_bm_cov_fw3 <- readRDS("rds/data/log/data_adm0_afr_osv_bm_cov.rds") %>%
  filter(year <= 2022) %>%
  group_by(gwno) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm0_afr_2022_osv_bm_cov_gtw_fw3 <- readRDS("rds/data/log/data_adm0_afr_osv_bm_cov_gtw.rds") %>%
  filter(year <= 2022) %>%
  group_by(gwno) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
set.seed(0815)
rf_adm0_afr_2022_osv_bm_fw3 <- train(osv_fat_be_log ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                     ...
                                     verbose = FALSE)
saveRDS(rf_adm0_afr_2022_osv_bm_fw3, "rds/ml_models/log/rf_adm0_afr_2022_osv_bm_fw3.rds")

set.seed(0815)
rf_adm0_afr_2022_osv_cov_fw3 <- train(osv_fat_be_log ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                      ...
                                      importance = "permutation",
                                      verbose = FALSE)
saveRDS(rf_adm0_afr_2022_osv_cov_fw3, "rds/ml_models/log/rf_adm0_afr_2022_osv_cov_fw3.rds")

set.seed(0815)
rf_adm0_afr_2022_osv_gtw_fw3 <- train(osv_fat_be_log ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                      ...
                                      importance = "permutation",
                                      verbose = FALSE)
saveRDS(rf_adm0_afr_2022_osv_gtw_fw3, "rds/ml_models/log/rf_adm0_afr_2022_osv_gtw_fw3.rds")

set.seed(0815)
rf_adm0_afr_2022_osv_bm_gtw_fw3 <- train(osv_fat_be_log ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                         ...
                                         importance = "permutation",
                                         verbose = FALSE)
saveRDS(rf_adm0_afr_2022_osv_bm_gtw_fw3, "rds/ml_models/log/rf_adm0_afr_2022_osv_bm_gtw_fw3.rds")

set.seed(0815)
rf_adm0_afr_2022_osv_cov_gtw_fw3 <- train(osv_fat_be_log ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                          ...
                                          importance = "permutation",
                                          verbose = FALSE)
saveRDS(rf_adm0_afr_2022_osv_cov_gtw_fw3, "rds/ml_models/log/rf_adm0_afr_2022_osv_cov_gtw_fw3.rds")

set.seed(0815)
rf_adm0_afr_2022_osv_bm_cov_fw3 <- train(osv_fat_be_log ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                         ...
                                         importance = "permutation",
                                         verbose = FALSE)
saveRDS(rf_adm0_afr_2022_osv_bm_cov_fw3, "rds/ml_models/log/rf_adm0_afr_2022_osv_bm_cov_fw3.rds")

set.seed(0815)
rf_adm0_afr_2022_osv_bm_cov_gtw_fw3 <- train(osv_fat_be_log ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                             ...
                                             importance = "permutation",
                                             verbose = FALSE)
saveRDS(rf_adm0_afr_2022_osv_bm_cov_gtw_fw3, "rds/ml_models/log/rf_adm0_afr_2022_osv_bm_cov_gtw_fw3.rds")
...
# rfbm_adm0_afr_2022_osv_cov_fw3 <- readRDS("rds/ml_models/log/rfbm_adm0_afr_2022_osv_cov_fw3.rds")
# rfbm_adm0_afr_2022_osv_gtw_fw3 <- readRDS("rds/ml_models/log/rfbm_adm0_afr_2022_osv_gtw_fw3.rds")
# rfcov_adm0_afr_2022_osv_gtw_fw3 <- readRDS("rds/ml_models/log/rfcov_adm0_afr_2022_osv_gtw_fw3.rds")
# rfbm_cov_adm0_afr_2022_osv_gtw_fw3 <- readRDS("rds/ml_models/log/rfbm_cov_adm0_afr_2022_osv_gtw_fw3.rds")
...
saveRDS(train_adm0_afr_2022_osv_bm_fw3, "rds/predictions/log/train_adm0_afr_2022_osv_bm_fw3.rds")
saveRDS(test_adm0_afr_2022_osv_bm_fw3, "rds/predictions/log/test_adm0_afr_2022_osv_bm_fw3.rds")
...
saveRDS(train_adm0_afr_2022_osv_cov_fw3, "rds/predictions/log/train_adm0_afr_2022_osv_cov_fw3.rds")
saveRDS(test_adm0_afr_2022_osv_cov_fw3, "rds/predictions/log/test_adm0_afr_2022_osv_cov_fw3.rds")
...
saveRDS(train_adm0_afr_2022_osv_gtw_fw3, "rds/predictions/log/train_adm0_afr_2022_osv_gtw_fw3.rds")
saveRDS(test_adm0_afr_2022_osv_gtw_fw3, "rds/predictions/log/test_adm0_afr_2022_osv_gtw_fw3.rds")
...
saveRDS(train_adm0_afr_2022_osv_bm_cov_fw3, "rds/predictions/log/train_adm0_afr_2022_osv_bm_cov_fw3.rds")
saveRDS(test_adm0_afr_2022_osv_bm_cov_fw3, "rds/predictions/log/test_adm0_afr_2022_osv_bm_cov_fw3.rds")
...
saveRDS(train_adm0_afr_2022_osv_bm_gtw_fw3, "rds/predictions/log/train_adm0_afr_2022_osv_bm_gtw_fw3.rds")
saveRDS(test_adm0_afr_2022_osv_bm_gtw_fw3, "rds/predictions/log/test_adm0_afr_2022_osv_bm_gtw_fw3.rds")
...
saveRDS(train_adm0_afr_2022_osv_cov_gtw_fw3, "rds/predictions/log/train_adm0_afr_2022_osv_cov_gtw_fw3.rds")
saveRDS(test_adm0_afr_2022_osv_cov_gtw_fw3, "rds/predictions/log/test_adm0_afr_2022_osv_cov_gtw_fw3.rds")
...
saveRDS(train_adm0_afr_2022_osv_bm_cov_gtw_fw3, "rds/predictions/log/train_adm0_afr_2022_osv_bm_cov_gtw_fw3.rds")
saveRDS(test_adm0_afr_2022_osv_bm_cov_gtw_fw3, "rds/predictions/log/test_adm0_afr_2022_osv_bm_cov_gtw_fw3.rds")
