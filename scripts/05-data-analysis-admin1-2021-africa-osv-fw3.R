...
data_adm1_afr_2021_osv_bm_fw3 <- readRDS("rds/data/data_adm1_afr_osv_bm.rds") %>%
  filter(year <= 2021) %>%
...
data_adm1_afr_2021_osv_gtw_fw3 <- readRDS("rds/data/data_adm1_afr_osv_gtw.rds") %>%
  filter(year <= 2021) %>%
  group_by(isocode2full) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm1_afr_2021_osv_cov_fw3 <- readRDS("rds/data/data_adm1_afr_osv_cov.rds") %>%
  filter(year <= 2021) %>%
  group_by(isocode2full) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm1_afr_2021_osv_bm_gtw_fw3 <- readRDS("rds/data/data_adm1_afr_osv_bm_gtw.rds") %>%
  filter(year <= 2021) %>%
  group_by(isocode2full) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm1_afr_2021_osv_cov_gtw_fw3 <- readRDS("rds/data/data_adm1_afr_osv_cov_gtw.rds") %>%
  filter(year <= 2021) %>%
  group_by(isocode2full) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm1_afr_2021_osv_bm_cov_fw3 <- readRDS("rds/data/data_adm1_afr_osv_bm_cov.rds") %>%
  filter(year <= 2021) %>%
  group_by(isocode2full) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm1_afr_2021_osv_bm_cov_gtw_fw3 <- readRDS("rds/data/data_adm1_afr_osv_bm_cov_gtw.rds") %>%
  filter(year <= 2021) %>%
  group_by(isocode2full) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
set.seed(0815)
rf_adm1_afr_2021_osv_bm_fw3 <- train(osv_fat_be ~. - gadmname - isocode2full - year - month - timeindex,
                                     ...
                                     verbose = FALSE)
saveRDS(rf_adm1_afr_2021_osv_bm_fw3, "rds/ml_models/rf_adm1_afr_2021_osv_bm_fw3.rds")

set.seed(0815)
rf_adm1_afr_2021_osv_cov_fw3 <- train(osv_fat_be ~. - gadmname - isocode2full - year - month - timeindex,
                                      ...
                                      importance = "permutation",
                                      verbose = FALSE)
saveRDS(rf_adm1_afr_2021_osv_cov_fw3, "rds/ml_models/rf_adm1_afr_2021_osv_cov_fw3.rds")

set.seed(0815)
rf_adm1_afr_2021_osv_gtw_fw3 <- train(osv_fat_be ~. - gadmname - isocode2full - year - month - timeindex,
                                      ...
                                      importance = "permutation",
                                      verbose = FALSE)
saveRDS(rf_adm1_afr_2021_osv_gtw_fw3, "rds/ml_models/rf_adm1_afr_2021_osv_gtw_fw3.rds")

set.seed(0815)
rf_adm1_afr_2021_osv_bm_gtw_fw3 <- train(osv_fat_be ~. - gadmname - isocode2full - year - month - timeindex,
                                         ...
                                         importance = "permutation",
                                         verbose = FALSE)
saveRDS(rf_adm1_afr_2021_osv_bm_gtw_fw3, "rds/ml_models/rf_adm1_afr_2021_osv_bm_gtw_fw3.rds")

set.seed(0815)
rf_adm1_afr_2021_osv_cov_gtw_fw3 <- train(osv_fat_be ~. - gadmname - isocode2full - year - month - timeindex,
                                          ...
                                          importance = "permutation",
                                          verbose = FALSE)
saveRDS(rf_adm1_afr_2021_osv_cov_gtw_fw3, "rds/ml_models/rf_adm1_afr_2021_osv_cov_gtw_fw3.rds")

set.seed(0815)
rf_adm1_afr_2021_osv_bm_cov_fw3 <- train(osv_fat_be ~. - gadmname - isocode2full - year - month - timeindex,
                                         ...
                                         importance = "permutation",
                                         verbose = FALSE)
saveRDS(rf_adm1_afr_2021_osv_bm_cov_fw3, "rds/ml_models/rf_adm1_afr_2021_osv_bm_cov_fw3.rds")

set.seed(0815)
rf_adm1_afr_2021_osv_bm_cov_gtw_fw3 <- train(osv_fat_be ~. - gadmname - isocode2full - year - month - timeindex,
                                             ...
                                             importance = "permutation",
                                             verbose = FALSE)
saveRDS(rf_adm1_afr_2021_osv_bm_cov_gtw_fw3, "rds/ml_models/rf_adm1_afr_2021_osv_bm_cov_gtw_fw3.rds")
...
# rfbm_adm1_afr_2021_osv_cov_fw3 <- readRDS("rds/ml_models/rfbm_adm1_afr_2021_osv_cov_fw3.rds")
# rfbm_adm1_afr_2021_osv_gtw_fw3 <- readRDS("rds/ml_models/rfbm_adm1_afr_2021_osv_gtw_fw3.rds")
# rfcov_adm1_afr_2021_osv_gtw_fw3 <- readRDS("rds/ml_models/rfcov_adm1_afr_2021_osv_gtw_fw3.rds")
# rfbm_cov_adm1_afr_2021_osv_gtw_fw3 <- readRDS("rds/ml_models/rfbm_cov_adm1_afr_2021_osv_gtw_fw3.rds")
...
saveRDS(train_adm1_afr_2021_osv_bm_fw3, "rds/predictions/train_adm1_afr_2021_osv_bm_fw3.rds")
saveRDS(test_adm1_afr_2021_osv_bm_fw3, "rds/predictions/test_adm1_afr_2021_osv_bm_fw3.rds")
...
saveRDS(train_adm1_afr_2021_osv_cov_fw3, "rds/predictions/train_adm1_afr_2021_osv_cov_fw3.rds")
saveRDS(test_adm1_afr_2021_osv_cov_fw3, "rds/predictions/test_adm1_afr_2021_osv_cov_fw3.rds")
...
saveRDS(train_adm1_afr_2021_osv_gtw_fw3, "rds/predictions/train_adm1_afr_2021_osv_gtw_fw3.rds")
saveRDS(test_adm1_afr_2021_osv_gtw_fw3, "rds/predictions/test_adm1_afr_2021_osv_gtw_fw3.rds")
...
saveRDS(train_adm1_afr_2021_osv_bm_cov_fw3, "rds/predictions/train_adm1_afr_2021_osv_bm_cov_fw3.rds")
saveRDS(test_adm1_afr_2021_osv_bm_cov_fw3, "rds/predictions/test_adm1_afr_2021_osv_bm_cov_fw3.rds")
...
saveRDS(train_adm1_afr_2021_osv_bm_gtw_fw3, "rds/predictions/train_adm1_afr_2021_osv_bm_gtw_fw3.rds")
saveRDS(test_adm1_afr_2021_osv_bm_gtw_fw3, "rds/predictions/test_adm1_afr_2021_osv_bm_gtw_fw3.rds")
...
saveRDS(train_adm1_afr_2021_osv_cov_gtw_fw3, "rds/predictions/train_adm1_afr_2021_osv_cov_gtw_fw3.rds")
saveRDS(test_adm1_afr_2021_osv_cov_gtw_fw3, "rds/predictions/test_adm1_afr_2021_osv_cov_gtw_fw3.rds")
...
saveRDS(train_adm1_afr_2021_osv_bm_cov_gtw_fw3, "rds/predictions/train_adm1_afr_2021_osv_bm_cov_gtw_fw3.rds")
saveRDS(test_adm1_afr_2021_osv_bm_cov_gtw_fw3, "rds/predictions/test_adm1_afr_2021_osv_bm_cov_gtw_fw3.rds")
