...
data_adm0_afr_2022_osv_bm_fw3 <- readRDS("rds/data/data_adm0_afr_osv_bm.rds") %>%
  filter(year <= 2022) %>%
  group_by(gwno) %>%
...
data_adm0_afr_2022_osv_gtw_fw3 <- readRDS("rds/data/data_adm0_afr_osv_gtw.rds") %>%
  filter(year <= 2022) %>%
  group_by(gwno) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm0_afr_2022_osv_cov_fw3 <- readRDS("rds/data/data_adm0_afr_osv_cov.rds") %>%
  filter(year <= 2022) %>%
  group_by(gwno) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm0_afr_2022_osv_bm_gtw_fw3 <- readRDS("rds/data/data_adm0_afr_osv_bm_gtw.rds") %>%
  filter(year <= 2022) %>%
  group_by(gwno) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm0_afr_2022_osv_cov_gtw_fw3 <- readRDS("rds/data/data_adm0_afr_osv_cov_gtw.rds") %>%
  filter(year <= 2022) %>%
  group_by(gwno) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm0_afr_2022_osv_bm_cov_fw3 <- readRDS("rds/data/data_adm0_afr_osv_bm_cov.rds") %>%
  filter(year <= 2022) %>%
  group_by(gwno) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
data_adm0_afr_2022_osv_bm_cov_gtw_fw3 <- readRDS("rds/data/data_adm0_afr_osv_bm_cov_gtw.rds") %>%
  filter(year <= 2022) %>%
  group_by(gwno) %>%
  mutate(timeindex = row_number()) %>%
  ungroup() %>%
...
rf_adm0_afr_2022_osv_bm_fw3 <- train(osv_fat_be ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                     ...
                                     verbose = FALSE)
saveRDS(rf_adm0_afr_2022_osv_bm_fw3, "rds/ml_models/rf_adm0_afr_2022_osv_bm_fw3.rds")
...
rf_adm0_afr_2022_osv_cov_fw3 <- train(osv_fat_be ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                      ...
                                      importance = "permutation",
                                      verbose = FALSE)
saveRDS(rf_adm0_afr_2022_osv_cov_fw3, "rds/ml_models/rf_adm0_afr_2022_osv_cov_fw3.rds")
...
rf_adm0_afr_2022_osv_gtw_fw3 <- train(osv_fat_be ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                      ...
                                      importance = "permutation",
                                      verbose = FALSE)
saveRDS(rf_adm0_afr_2022_osv_gtw_fw3, "rds/ml_models/rf_adm0_afr_2022_osv_gtw_fw3.rds")
...
rf_adm0_afr_2022_osv_bm_gtw_fw3 <- train(osv_fat_be ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                         ...
                                         importance = "permutation",
                                         verbose = FALSE)
saveRDS(rf_adm0_afr_2022_osv_bm_gtw_fw3, "rds/ml_models/rf_adm0_afr_2022_osv_bm_gtw_fw3.rds")
...
rf_adm0_afr_2022_osv_cov_gtw_fw3 <- train(osv_fat_be ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                          ...
                                          importance = "permutation",
                                          verbose = FALSE)
saveRDS(rf_adm0_afr_2022_osv_cov_gtw_fw3, "rds/ml_models/rf_adm0_afr_2022_osv_cov_gtw_fw3.rds")
...
rf_adm0_afr_2022_osv_bm_cov_fw3 <- train(osv_fat_be ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                         ...
                                         importance = "permutation",
                                         verbose = FALSE)
saveRDS(rf_adm0_afr_2022_osv_bm_cov_fw3, "rds/ml_models/rf_adm0_afr_2022_osv_bm_cov_fw3.rds")
...
rf_adm0_afr_2022_osv_bm_cov_gtw_fw3 <- train(osv_fat_be ~. - country_name - gwno - year - month - yearmonth - timeindex,
                                             ...
                                             importance = "permutation",
                                             verbose = FALSE)
saveRDS(rf_adm0_afr_2022_osv_bm_cov_gtw_fw3, "rds/ml_models/rf_adm0_afr_2022_osv_bm_cov_gtw_fw3.rds")
...
# rfbm_adm0_afr_2022_osv_cov_fw3 <- readRDS("rds/ml_models/rfbm_adm0_afr_2022_osv_cov_fw3.rds")
# rfbm_adm0_afr_2022_osv_gtw_fw3 <- readRDS("rds/ml_models/rfbm_adm0_afr_2022_osv_gtw_fw3.rds")
# rfcov_adm0_afr_2022_osv_gtw_fw3 <- readRDS("rds/ml_models/rfcov_adm0_afr_2022_osv_gtw_fw3.rds")
# rfbm_cov_adm0_afr_2022_osv_gtw_fw3 <- readRDS("rds/ml_models/rfbm_cov_adm0_afr_2022_osv_gtw_fw3.rds")
...
saveRDS(train_adm0_afr_2022_osv_bm_fw3, "rds/predictions/train_adm0_afr_2022_osv_bm_fw3.rds")
saveRDS(test_adm0_afr_2022_osv_bm_fw3, "rds/predictions/test_adm0_afr_2022_osv_bm_fw3.rds")
...
saveRDS(train_adm0_afr_2022_osv_cov_fw3, "rds/predictions/train_adm0_afr_2022_osv_cov_fw3.rds")
saveRDS(test_adm0_afr_2022_osv_cov_fw3, "rds/predictions/test_adm0_afr_2022_osv_cov_fw3.rds")
...
saveRDS(train_adm0_afr_2022_osv_gtw_fw3, "rds/predictions/train_adm0_afr_2022_osv_gtw_fw3.rds")
saveRDS(test_adm0_afr_2022_osv_gtw_fw3, "rds/predictions/test_adm0_afr_2022_osv_gtw_fw3.rds")
...
saveRDS(train_adm0_afr_2022_osv_bm_cov_fw3, "rds/predictions/train_adm0_afr_2022_osv_bm_cov_fw3.rds")
saveRDS(test_adm0_afr_2022_osv_bm_cov_fw3, "rds/predictions/test_adm0_afr_2022_osv_bm_cov_fw3.rds")
...
saveRDS(train_adm0_afr_2022_osv_bm_gtw_fw3, "rds/predictions/train_adm0_afr_2022_osv_bm_gtw_fw3.rds")
saveRDS(test_adm0_afr_2022_osv_bm_gtw_fw3, "rds/predictions/test_adm0_afr_2022_osv_bm_gtw_fw3.rds")
...
saveRDS(train_adm0_afr_2022_osv_cov_gtw_fw3, "rds/predictions/train_adm0_afr_2022_osv_cov_gtw_fw3.rds")
saveRDS(test_adm0_afr_2022_osv_cov_gtw_fw3, "rds/predictions/test_adm0_afr_2022_osv_cov_gtw_fw3.rds")
...
saveRDS(train_adm0_afr_2022_osv_bm_cov_gtw_fw3, "rds/predictions/train_adm0_afr_2022_osv_bm_cov_gtw_fw3.rds")
saveRDS(test_adm0_afr_2022_osv_bm_cov_gtw_fw3, "rds/predictions/test_adm0_afr_2022_osv_bm_cov_gtw_fw3.rds")
