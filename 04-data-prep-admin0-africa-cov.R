...
saveRDS(data_adm0_afr_sbv_bm, "rds/data/cov/data_adm0_afr_sbv_bm.rds")
...
saveRDS(data_adm0_afr_osv_bm, "rds/data/cov/data_adm0_afr_osv_bm.rds")
...
saveRDS(data_adm0_afr_nsv_bm, "rds/data/cov/data_adm0_afr_nsv_bm.rds")
...
saveRDS(data_adm0_afr_sri_bm, "rds/data/cov/data_adm0_afr_sri_bm.rds")
...
data_adm0_afr_sbv_cov <- data %>%
  select(country_name, gwno, year, month, yearmonth,
         ...
         ## covariates
         #cinc, 
         elev_mean, ethfrac, ethpol, #farmland, 
         forest, #irregular,
         irst, milex, milper, #n_leaders, 
         nbuiltup, nethgr, #newlmtnest, 
         npetro,
         #open_terrain, 
         pec, 
         relfrac, relpol, road_density, road_length, rugged,
         #sum_igo_anytype, sum_igo_associate, sum_igo_full, sum_igo_observer,
         tpop, upop, 
         #v2x_polyarchy, wbgdp2011est, wbgdppc2011est, wbpopest, 
         #xm_qudsest,
...
saveRDS(data_adm0_afr_sbv_cov, "rds/data/cov/data_adm0_afr_sbv_cov.rds")
...
saveRDS(data_adm0_afr_osv_cov, "rds/data/cov/data_adm0_afr_osv_cov.rds")
...
saveRDS(data_adm0_afr_nsv_cov, "rds/data/cov/data_adm0_afr_nsv_cov.rds")
...
saveRDS(data_adm0_afr_sri_cov, "rds/data/cov/data_adm0_afr_sri_cov.rds")
...
saveRDS(data_adm0_afr_sbv_gtw, "rds/data/cov/data_adm0_afr_sbv_gtw.rds")
...
saveRDS(data_adm0_afr_osv_gtw, "rds/data/cov/data_adm0_afr_osv_gtw.rds")
...
saveRDS(data_adm0_afr_nsv_gtw, "rds/data/cov/data_adm0_afr_nsv_gtw.rds")
...
saveRDS(data_adm0_afr_sri_gtw, "rds/data/cov/data_adm0_afr_sri_gtw.rds")
...
saveRDS(data_adm0_afr_sbv_bm_cov_gtw, "rds/data/cov/data_adm0_afr_sbv_bm_cov_gtw.rds")
...
saveRDS(data_adm0_afr_osv_bm_cov_gtw, "rds/data/cov/data_adm0_afr_osv_bm_cov_gtw.rds")
...
saveRDS(data_adm0_afr_nsv_bm_cov_gtw, "rds/data/cov/data_adm0_afr_nsv_bm_cov_gtw.rds")
...
saveRDS(data_adm0_afr_sri_bm_cov_gtw, "rds/data/cov/data_adm0_afr_sri_bm_cov_gtw.rds")
